...
def _process_arch_dir(arch_url, version, repo, arch, output_dir, save=False, randint=2, cache=True):
    # 获取目录下所有 .apk 文件
...
def collect_alpine(output_dir="downloads/alpine", save=False, randint=2, cache=True):
    # 获取所有版本目录
